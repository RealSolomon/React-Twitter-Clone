...
export const UserPage: React.FC<RouteComponentProps<{ id: string }>> = ({
  ...
  return (
    <Paper
      className={classNames(classes.tweetWrapper, 'user')}
      variant="outlined"
    >
      ...
      <div className="user__info">
        ...
        <p className="user__info-description">
          Frontend Developer / UI Designer / JavaScript / ReactJS, NodeJS /
          Flutter
        </p>
        <ul className="user__info-details">
          <li>Kyiv, Ukraine</li>
          <li>
            <a className="link" href="https://github.com/RealSolomon">
              Real Solomon
            </a>
          </li>
          <li>Дата рождения: 7 января 1992 г.</li>
          <li>Регистрация: май 2015 г.</li>
        </ul>
      </div>
      <Tabs
        value={activeTab}
